...
if (st.session_state['current_q'] % 5) == 0:
...
"""
# Checkbox
checkbox_key_1 = f"first_state_{st.session_state['current_q']}"
checkbox_key_2 = f"second_state_{st.session_state['current_q']}"
st.write(check_css, unsafe_allow_html=True)
First = col1.checkbox("No.1", key=checkbox_key_1)
Second = col2.checkbox("No.2", key=checkbox_key_2)
